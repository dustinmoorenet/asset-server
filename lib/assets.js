...
Assets.prototype = {
   ...
   */
  get: function(id) {
    id = Assets.validateUUID(id) && Assets.cleanUUID(id);
  ...
  put: function(asset) {
    var id = Assets.validateUUID(asset.id) && Assets.cleanUUID(asset.id);
